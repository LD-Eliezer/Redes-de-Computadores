...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', action='store_true', help='Descriptografa o arquivo de entrada.')

    parser.add_argument('-v', action='store_true', help='Mostra informações sobre os parâmetross.')

    parser.add_argument('-a', type=str, choices=['des','des3','aes'], help='Algoritmo de criptografia simétrica.')

    parser.add_argument('-i', type=str, help='Arquivo de entrada.', required=True)
    parser.add_argument('-o', type=str, help='Arquivo de saída.')
